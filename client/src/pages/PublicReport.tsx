...
export default function PublicReport() {
  ...
  if (error || !audit) return <ErrorState message={error?.message ?? "Report not found."} />;
  if (audit.status !== "completed") return <ErrorState message="This report is not yet available." />;
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="container max-w-5xl mx-auto py-10 space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-primary/15 text-primary font-medium">Personalized</span>
                </div>
        ...
        <div className="rounded-2xl bg-gradient-to-br from-primary/10 to-violet-500/5 border border-primary/20 p-8 text-center">
          ...
          <h3 className="text-xl font-bold mb-2">How AI-Ready is YOUR website?</h3>
          <p className="text-muted-foreground text-sm mb-6 max-w-md mx-auto">
            Get a free AI-Readiness score for any URL in under 60 seconds. No signup required.
          </p>
          <Button
            onClick={() => navigate("/")}
      ...
      {score >= 70 && (
        <div>
          ...
          >
            ...
            Embed AI-Ready badge on your website
          </button>
          {showBadge && (
      ...
      <div className="flex flex-col lg:flex-row items-center gap-8">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-xs text-muted-foreground mb-6">
            Audited on {new Date(auditDate).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}
          </p>
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground">{cat.weight}% of total</div>
                  </div>
                </div>
  ...
  return (
    <div>
      ...
      <p className="text-xs text-muted-foreground mt-3 text-center">
        Full report with all recommendations available at{" "}
        <a href="/" className="text-primary hover:underline">GEO-Auditor</a>
      </p>
    </div>
  );
