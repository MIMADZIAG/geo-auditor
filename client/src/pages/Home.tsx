  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" style={{ color: "#20b2aa" }}>
        <path d="M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10z" fill="none" stroke="currentColor" strokeWidth="1.5"/>
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none">
        <path d="M12 2L9 9H2l5.5 4L5 20l7-5 7 5-2.5-7L22 9h-7L12 2z" stroke="#8b5cf6" strokeWidth="1.5" strokeLinejoin="round" fill="none"/>
      </svg>
    ),
  },
  {
    ...
    color: "#d97706",
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor" style={{ color: "#d97706" }}>
        <circle cx="12" cy="12" r="10" fill="none" stroke="currentColor" strokeWidth="1.5"/>
        <path d="M8 12c0-2.21 1.79-4 4-4s4 1.79 4 4-1.79 4-4 4-4-1.79-4-4z" fill="currentColor" opacity="0.4"/>
