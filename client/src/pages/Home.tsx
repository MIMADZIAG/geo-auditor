...
const AI_ENGINES = [
  ...
  },
  {
    name: "Perplexity",
    color: "#20b2aa",
    // Official Perplexity snowflake/asterisk mark
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none">
        {/* Vertical bar */}
        <line x1="12" y1="2" x2="12" y2="22" stroke="#20b2aa" strokeWidth="2" strokeLinecap="round"/>
        {/* Top-left diagonal */}
        <line x1="12" y1="2" x2="5" y2="8" stroke="#20b2aa" strokeWidth="2" strokeLinecap="round"/>
        {/* Top-right diagonal */}
        <line x1="12" y1="2" x2="19" y2="8" stroke="#20b2aa" strokeWidth="2" strokeLinecap="round"/>
        {/* Bottom-left diagonal */}
        <line x1="12" y1="22" x2="5" y2="16" stroke="#20b2aa" strokeWidth="2" strokeLinecap="round"/>
        {/* Bottom-right diagonal */}
        <line x1="12" y1="22" x2="19" y2="16" stroke="#20b2aa" strokeWidth="2" strokeLinecap="round"/>
        {/* Horizontal bar */}
        <line x1="3" y1="12" x2="21" y2="12" stroke="#20b2aa" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    ),
  },
  {
    name: "Gemini",
    color: "#4285f4",
    // Official Gemini 4-pointed star (sparkle) — the actual Gemini logomark
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none">
        <defs>
        ...
        {/* Gemini 4-pointed star: two thin diamond shapes crossing */}
        <path
          d="M12 2 C12 2 13.5 9 12 12 C10.5 9 12 2 12 2Z"
          fill="url(#geminiGrad)"
        />
        <path
          d="M12 22 C12 22 10.5 15 12 12 C13.5 15 12 22 12 22Z"
          fill="url(#geminiGrad)"
        />
        <path
          d="M2 12 C2 12 9 10.5 12 12 C9 13.5 2 12 2 12Z"
          fill="url(#geminiGrad)"
        />
        <path
          d="M22 12 C22 12 15 13.5 12 12 C15 10.5 22 12 22 12Z"
          fill="url(#geminiGrad)"
        />
      </svg>
    ),
  },
  {
    name: "Claude",
    color: "#D4A27F",
    // Official Claude / Anthropic asterisk mark — 6-petal starburst
    icon: (
      <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none">
        {/* 6 lines radiating from center — the Anthropic asterisk */}
        <line x1="12" y1="2.5" x2="12" y2="21.5" stroke="#D4A27F" strokeWidth="2.2" strokeLinecap="round"/>
        <line x1="3.2" y1="7" x2="20.8" y2="17" stroke="#D4A27F" strokeWidth="2.2" strokeLinecap="round"/>
        <line x1="20.8" y1="7" x2="3.2" y2="17" stroke="#D4A27F" strokeWidth="2.2" strokeLinecap="round"/>
      </svg>
    ),
  },
];
