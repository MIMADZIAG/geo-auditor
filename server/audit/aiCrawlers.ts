...
const AI_CRAWLERS: CrawlerInfo[] = [
  {
    ...
    name: "GPTBot",
    userAgent: "GPTBot",
    engine: "ChatGPT / OpenAI (Training)",
    description: "OpenAI's crawler used to train GPT models. Blocking this prevents future GPT model training on your content.",
    priority: "critical",
  },
  {
    id: "oai_searchbot",
  ...
  },
  {
    ...
    description: "Google's opt-out token for AI training data (Gemini, Vertex AI, AI Overviews). Blocking this reduces visibility in Google AI features.",
    priority: "critical",
  },
  {
    id: "anthropic_ai",
