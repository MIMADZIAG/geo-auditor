...
## PLG Killer Redesign — "AI Search Report Card"

### Strategy
- [x] Analiza PLG wzorców (Spotify Wrapped, HubSpot Grader, GTmetrix)
- [x] Backup obecnej wersji (v1-backup/)
- [x] Nowy landing page z social proof counter i przykładowym raportem
- [x] Animowany loading screen z live updates
- [x] Redesign wyników: 3 filary (Findability, Trustworthiness, Answerability)
- [x] Animowany reveal score (licznik 0→X)
- [x] Plain language dla non-specialists (bez żargonu)
- [x] Email capture gate (po pokazaniu score, przed pełnym raportem)
- [x] Shareable card (LinkedIn/Twitter + branded mini card)
- [x] Fix: rate limit copy (5/month, nie 3/day)
- [x] Pricing page z planem Free/Starter/Pro/Business
- [x] PLG upgrade flow (contextual upsell triggers)
- [x] DB: email_leads table + captureEmail tRPC procedure
- [x] Human-readable check labels (no jargon)
- [x] /pricing route registered in App.tsx
